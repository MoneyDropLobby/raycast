...
import { Plus, Edit, Trash2, MoreHorizontal, ChevronRight, ChevronDown, FolderPlus, ArrowLeft } from "lucide-react"
...
export function CategoryHierarchyManager() {
  const { categories, addCategory, updateCategory, removeCategory, getCategoryPath, getCategoryChildren } =
